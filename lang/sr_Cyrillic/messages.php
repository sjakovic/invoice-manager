...
return [
    ...
    'invoice_pdf_info' => 'На основу члана 33 Закона о ПДВ, овај рачун је ослобођен пореза на додату вредност.<br>Овај рачун је валидан без печата и потписа.',
